<template>
    ...
    <div class="container"  >
      ...
      <ul id="myTab" class="nav nav-tabs" :data="allData" >
        ...
        <li @click="educlick"><a  data-toggle="tab"  index="1">教育</a></li>
        <li @click="educlick"><a  data-toggle="tab" index="2">医疗</a></li>
        <li @click="educlick"><a  data-toggle="tab" index="3">电力</a></li>
        <li @click="educlick"><a  data-toggle="tab" index="4">金融</a></li>
      ...
      <div id="myTabContent" class="tab-content">
        <div class="tab-pane fade in active" id="all" >
          ...
          <div class=" col-set-1 pic"  v-for="(item,index) in allData" :key="index">
            <div class="contain" style=" overflow:hidden; display:inline-block;" >

              <router-link :to="{path: '/businessSolutionDetails', query: {solutionId: item.id}}" >
