    ...
    <div class="container">
      <div class="col-xs-12 col-md-4">
        <div class="contain" style=" display:inline-block;" :data="products">
          ...
          <div class="grid-con  carousel slide" id="myCarousel" >
            <!-- 轮播（Carousel）指标 -->
      ...
      <div class="col-xs-12 col-md-4" :data="industryData">
          ...
          <div id="myTabContent" class="tab-content">
            <div class="tab-pane fade in active" id="design">
              <ul class="lists"  :data="planningDesign">
                <router-link v-for="item in planningDesign" :to="{path: '/businessSupportPreview', query: {solutionId: item.id}}" :key="item.id">
            ...
            <div class="tab-pane fade" id="test">
              <ul class="lists" :data="safetyTesting">
                <router-link  v-for="item in safetyTesting" :to="{path: '/businessSupportPreview', query: {solutionId: item.id}}" :key="item.id">
                  <li class="item" ><i class="iconfont icon">&#xe602;</i>{{item.fileName}}</li>
                </router-link>
              </ul>
            </div>
            <div class="tab-pane fade" id="set">
              <ul class="lists"  :data="deploymentInstallation" >
                <router-link v-for="item in deploymentInstallation" :to="{path: '/businessSupportPreview', query: {solutionId: item.id}}" :key="item.id">
                  <li class="item"><i class="iconfont icon">&#xe602;</i>{{item.fileName}}</li>
                </router-link>
              </ul>
            </div>
            <div class="tab-pane fade" id="guidence">
              <ul class="lists" :data="maintenanceGuidance">
                <router-link  v-for="item in maintenanceGuidance" :to="{path: '/businessSupportPreview', query: {solutionId: item.id}}" :key="item.id">
                  <li class="item"><i class="iconfont icon">&#xe602;</i>{{item.fileName}}</li>
                </router-link>
              </ul>
            </div>
...
//              console.log(res.data);
      ...
      getVideo(){
        let para = {
          videoId:this.$route.query.solutionId,
        }
