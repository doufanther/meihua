<template>
  <div>
        ...
        <div class="col-sm-8 col-sm-offset-2 col-xs-12 s-inner">
          <form class="request-form ng-pristine ng-valid">
            <div class="form-group"  :model="filters">
              ...
              <router-link to="{path: '/searchPage',  query:{filters.name}} " target="_blank" ><span  class="glyphicon" @click="filter" ><i class="iconfont">&#xe761;</i></span></router-link>
            </div>
          </form>
        </div>
      </div>
    ...
    <div class="container">
      <div class="txt">
        <h2 class="text-center">按解决方案找支持</h2>
        <h5 class="text-center">可按照解决方案查找相对应的设计指导、部署安装和测试指导等帮助</h5>
      </div>

    </div>
    <div class="container">
      <div class="row solution"  >
        <div class="col-md-4 col-sm-4 col-xs-4 col-xs-1" :data="industryData">
          <div class="title">
        ...
        <div class="col-md-4 col-sm-4 col-xs-4 col-xs-1" :data="businessData">
          <div class="title">
        ...
        <div class="col-md-4 col-sm-4 col-xs-4 col-xs-1">
          <div class="title">
...
<style lang="scss" scoped>
  .txt{
    text-align: center;
    margin: 80px 0 62px;
    h2{color:323232;font-size: 32px;margin-bottom:27px;}
